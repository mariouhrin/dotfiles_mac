...
# ranger alias
alias r="ranger"
# ranger kill all processes
alias qt="for pid in $(ps | grep "/bin/bash" | grep --invert-match 'color=auto' | awk '{print $1}'); do kill -9 $pid; done"
alias qr="for pid in $(ps | grep "ranger" | grep --invert-match 'color=auto' | awk '{print $1}'); do kill -9 $pid; done"
